...
formContact.addEventListener("submit", (e) => {
   ...
   if (!name.trim() || !email.trim()) {
      Swal.fire({
         title: "Error",
         text: "Mohon isi form Anda dengan benar!",
         icon: "error",
         button: "Okay",
   ...
   Swal.fire({
      title: "Announcement",
      text: "Perhatikan, pastikan email yang anda masukkan benar!",
      icon: "info",
      button: "Okay",
      ...
      if (result.isConfirmed) {
         window.location.href = `mailto:cs.almediacreative@gmail.com?subject=Contact%20from%20${name}&body=${message}`;
      }
   });
